...
export default function ChangeLog({ changeLogOpen, setChangeLogOpen }) {
  return (
    <Transition.Root show={changeLogOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setChangeLogOpen}>
        <Transition.Child
          as={Fragment}
