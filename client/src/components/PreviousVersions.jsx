...
import { PREVIOUS_VERSIONS } from "../data";

export default function PreviousVersions({ previousVersionOpen, setPreviousVersionOpen }) {
  return (
    <Transition.Root show={previousVersionOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setPreviousVersionOpen}>
        <Transition.Child
          as={Fragment}
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-2 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2 grid grid-cols-1 border-t border-gray-100 pt-4">
                      {PREVIOUS_VERSIONS.map((previous) => (
                        <div key={previous.id} className="pb-2">
                          ...
                          <a className="text-sm font-semibold leading-6 text-red-300" href={previous.href}>
                            Download
                          </a>
                        </div>
                      ))}
